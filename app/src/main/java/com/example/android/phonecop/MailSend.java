...
public class MailSend {
    ...
    MailSend(String base64){
        ...
        HTMLContent="<p style=\"text-align: center;\"><span style=\"font-size: 24px;\"><strong><span style=\"color: rgb(255, 0, 0);\">PhoneCop Intrusion Alert</span></strong></span></p>\n" +
    ...
    static void SendMail(String HTML) throws JSONException, MailjetSocketTimeoutException, MailjetException {
        ...
        client = new MailjetClient("1e23e15c27bfd2bfec5eed248eb9b469", "a41cceee6654a5360099f302b9e745d0", new ClientOptions("v3.1"));
        //The request contains various JSON objects and JSON key-value pairs
        request = new MailjetRequest(Emailv31.resource)
                .property(Emailv31.MESSAGES, new JSONArray()
                        .put(new JSONObject()
                                .put(Emailv31.Message.FROM, new JSONObject()
                                        .put("Email", "phonecophelpdesk@gmail.com")
                                        .put("Name", "PhoneCop"))
                                .put(Emailv31.Message.TO, new JSONArray()
                                        .put(new JSONObject()
                                                .put("Email", SecurityService.senderEmail)
                                                .put("Name", "Client")))
                                .put(Emailv31.Message.SUBJECT, "Greetings from PhoneCop")
